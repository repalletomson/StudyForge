...
import { FiArrowLeft, FiSave, FiCheck, FiX, FiImage, FiBookOpen } from 'react-icons/fi';
...
const NewProgramPage = () => {
  ...
  const createProgramMutation = useMutation(programApi.createProgram, {
    onSuccess: (data) => {
      ...
      navigate(`/dashboard/programs/${data.program._id}`);
    },
    onError: (error) => {
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-1">Add a new educational program to your catalog</p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-blue-900/20 rounded-lg border border-blue-800 p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h2 className="text-xl font-semibold text-blue-300">Publishing Workflow</h2>
                </div>
                
                <div className="space-y-3 text-sm text-blue-200">
                  <div className="flex items-start space-x-2">
                    <span className="text-blue-400 font-bold">1.</span>
                    <p>New programs are created in <strong>Draft</strong> status automatically</p>
                  </div>
                  <div className="flex items-start space-x-2">
                    <span className="text-blue-400 font-bold">2.</span>
                    <p>Programs automatically <strong>publish</strong> when the first lesson is added</p>
                  </div>
                  <div className="flex items-start space-x-2">
                    <span className="text-blue-400 font-bold">3.</span>
                    <p>Portrait and landscape assets are required for publishing</p>
                  </div>
                </div>
              </div>
              {/* Topics Selection */}
